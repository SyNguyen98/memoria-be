...
public class ItemController {
    ...
    @GetMapping
    public ResponseEntity<List<ItemRecord>> getAllItemsByLocationId(@CurrentUser UserPrincipal userPrincipal,
    ...
    @GetMapping("/{itemId}")
    public ResponseEntity<ItemRecord> getItemById(@PathVariable final String itemId) {
